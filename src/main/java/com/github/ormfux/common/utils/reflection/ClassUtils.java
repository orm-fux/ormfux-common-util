...
public final class ClassUtils {
    ...
    public static <T> T createObject(final Class<T> objectType, 
        ...
        try {
            ...
            throw new com.github.ormfux.common.utils.reflection.exception.InstantiationException("Error creating new instance of class " + objectType, e);
        }
    }
    ...
    public static boolean isReadable(final Class<?> clazz, final String fieldName) {
        if (check(getField(clazz, fieldName), Field::getModifiers, Modifier::isPublic)) {
            return true;
        }
    ...
    public static boolean isWriteable(final Class<?> clazz, final String fieldName, final Object value) {
        ...
        if (check(field, Field::getModifiers, Modifier::isPublic)) {
            if (isNull(value)) {
    ...
    public static Field getField(final Class<?> clazz, final String fieldName) {
        if (check(fieldName, String::isEmpty, true)) {
